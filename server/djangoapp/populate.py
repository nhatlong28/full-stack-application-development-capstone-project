...
def initiate():
    car_make_data = [
        {"name":"NISSAN", "description":"Great cars. High quality"},
        {"name":"Mercedes", "description":"Great cars. High quality"},
        {"name":"Audi", "description":"Great cars. High quality"},
        {"name":"Kia", "description":"Great cars. High quality"},
        {"name":"Toyota", "description":"Great cars. High quality"},
    ]
